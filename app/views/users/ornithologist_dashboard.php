<!--This is the ornithologist dashboard, it is where people will be redirected after havin successfully logged in as an ornithologist-->
<html lang="en">
<head>
...
<div id="wrapper">
    ...
    <main role="main" class="row" id="body">
        <div class="col-md-3" style="padding-left:50px;">
            <h3>Add sites</h3>
            <hr>
            <button type="button" style="margin-bottom:10px;" class="col-md-12 btn btn-custom" data-toggle="modal"
                    data-target="#ScoutModal">Add scouting site <i class="fas fa-flag" style="color:red;"></i></button>
            <button type="button" style="margin-bottom:10px;" class="col-md-12 btn btn-custom" data-toggle="modal"
                    data-target="#NestModal">Add nest site <i class="fa fa-map-pin" style="color:red;"></i></button>
            <hr>
                        ...
                        <tr>
                            <td>
                                <button class="button-table"
                                        onclick="setLocation(<?php echo $row->latitude; ?>, <?php echo $row->longitude; ?>)"><?php echo $row->name; ?></button>
                            </td>
                        </tr>
                    <?php
                    endforeach;
        ...
        <div class="modal fade" id="NestModal">
            <div class="modal-dialog modal-lg">
                <form action="<?php echo URLROOT; ?>/users/ornithologist_dashboard/0" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="custom-file" style="padding: 30px;">
                                            <input name="pins" id="pins" type="file" accept=".csv"
                                                   class="custom-file-input">
                                            <label for="pins" class="custom-file-label text-truncate">Choose
                                                file...(.csv)</label>
                                        </div>
                                        <br><br>
                                    </div>
        ...
        <div class="modal fade" id="ScoutModal">
            <div class="modal-dialog modal-lg">
                <form action="<?php echo URLROOT; ?>/users/ornithologist_dashboard/1" method="post"
                      enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="modal-container">
...
<!-- Javascript -->
<script>
    //Script to set the file chooser textbox text to the name of the file currently chosen
    ...
    function myMap() {
        ...
        //PHP script to create markers on the map for all nest sites currently in the database
        <?php
        if (!empty($data['nests'])) {
    ...
    //Method to set the center of the map to a certain locatio, useful for the scouting location buttons
    function setLocation(newLat, newLng) {
        map.setCenter({lat: newLat, lng: newLng});
    }

    //Filter function used by the search bar on the table of scouting sites
    ...
    //Initialise a tooltip that will show a message when hovered over
