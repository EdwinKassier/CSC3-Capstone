<!--This is the add admin page and is used by admins to add other admins to the database-->
<form action="<?php echo URLROOT; ?>/admins/add_admin" method="post">
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <input type="text" class="form-control" name="register_name" value="<?php echo $data['name']; ?>"
                   placeholder="Enter first name" required>
        </div>
        <div class="col-md-6 form-group">
            <label for="register_surname"><b>Last name</b></label>
            <input type="text" class="form-control" name="register_surname" value="<?php echo $data['surname']; ?>"
