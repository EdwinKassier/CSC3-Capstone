<!--This is the register page where users will sign up to th website-->
<html lang="en">
<head>
            ...
            <div class="container customContainer">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <select class="form-control" name="register_role" required>
                            <option value='' <?php if (empty($data['role'])) {
                                echo 'selected';
                            } ?>>Choose...
                            </option>
                ...
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="register_organization_name"
                               value="<?php echo $data['organization_name']; ?>"
                    ...
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="register_organization_number"
                               value="<?php echo $data['organization_number']; ?>"
                               placeholder="Enter company/organization number" required>
                    </div>
                </div>
                <div style="float:right">
                    <button type="submit" name="register" class="btn btn-custom">Sign up</button>
                    <button type="reset" class="btn btn-custom" onclick="location.href='<?php echo URLROOT; ?>/'">Back
                    </button>
                </div>
                <br><br>
                <p style="float:right" class="text-muted">By creating an account you agree to our <a
                            href="<?php echo URLROOT; ?>\resources\files\blackeagle_terms&conditions.pdf"
