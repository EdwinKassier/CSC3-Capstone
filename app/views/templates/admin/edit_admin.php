<form action="<?php echo URLROOT; ?>/admins/edit_admin/<?php echo $data['id']; ?>" method="post">
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <input type="text" class="form-control" name="update_name" value="<?php echo $data['name']; ?>" placeholder="Enter first name" required>
        </div>
        <div class="col-md-6 form-group">
            <label for="update_surname"><b>Last name</b></label>
            <input type="text" class="form-control" name="update_surname" value="<?php echo $data['surname'];?>" placeholder="Enter last name" required>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 form-group">
            <label for="update_password"><b>Password:</b></label>
            <input type="password" class="form-control" name="update_password" value="<?php echo $data['password']; ?>" placeholder="Enter password to change">
        </div>
        <div class="col-md-6 form-group">
            <label for="update_confirm_password"><b>Confirm Password:</b></label>
            <input type="password" class="form-control" name="update_confirm_password" value="<?php echo $data['confirm_password']; ?>" placeholder="Enter password to change">
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 form-group">
